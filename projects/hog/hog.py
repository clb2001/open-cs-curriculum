...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        ...
        res = gcd(player_score, opponent_score)
        if res >= 10:
            return True
        else:
            return False
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    sub = opponent_score - player_score
    if (sub > 0 and sub < 3):
        return True
    else:
        return False 
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    # def process(strategy, score0, score1, dice):
    ...
    #     if other(who):
    #         process(strategy0, score0, score1, dice)
    #         if score0 >= goal:
    #             break
    #         process(strategy1, score1, score0, dice)
    #     else:
    #         process(strategy1, score1, score0, dice)
    #         if score1 >= goal:
    #             break
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            ...
            if tmp > running_high:
                print('{0} point(s)! The most yet for Player 0'.format(tmp))
        ...
        # who = 1, player1
            ...
            if tmp > running_high:
                print('{0} point(s)! The most yet for Player 1'.format(tmp))
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    MAX = 1
    for i in range(1, 11):
        tmp = make_averaged(roll_dice, trials_count)(i, dice)
        if tmp > MAXTMP:
            MAXTMP = tmp
            MAX = i
    return MAX
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    return 0 if (extra_turn(score + free_bacon(opponent_score), opponent_score) or free_bacon(opponent_score) >= cutoff) else num_rolls  # Replace this statement
    # END PROBLEM 11
